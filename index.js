...
// Same visual language as Fawn's infoblock: glassy rounded card, theme-aware
// color-mix tints, FontAwesome icons, collapsible details, 2-col grid.
...
// Same content fields as before, but the model is told to wrap them in
// the styled HTML structure shown below.
...
<div class="enaenn-tracker-block">
  <details class="ent-cont" open>
    <summary class="ent-top">
      <span><i class="fa-solid fa-clapperboard"></i> Tracker</span>
      <span><i class="fa-solid fa-location-dot"></i> [SHORT LOCATION LABEL]</span>
    </summary>
    ...
    <div class="ent-content">
      ...
      <div class="ent-section">
        <div class="ent-h"><i class="fa-solid fa-clapperboard"></i> Scene</div>
        <div class="ent-scene">[Concise 1-sentence description of agents' spatial positions]</div>
      </div>

      <!-- 💖 AGENTS PRESENT -->
      <div class="ent-section">
        <div class="ent-h"><i class="fa-solid fa-heart"></i> Agents Present</div>
        <div class="ent-agents">

          <!-- Repeat one .ent-agent block per present agent.
               If user is alone, REPLACE the whole .ent-agents grid with:
               <div class="ent-scene">No agents present.</div>
               USER IS NOT AN AGENT — never include the user here. -->
          ...
          <div class="ent-agent">
            ...
            <div class="ent-impulse"><i class="fa-solid fa-bullseye"></i> [Active impulse.]</div>
          </div>

        </div>
      </div>

      <!-- 🌍 OFF-SCREEN AGENTS (collapsible) -->
      <details class="ent-card">
        <summary class="ent-card-h"><i class="fa-solid fa-globe"></i> Off-Screen Agents</summary>

        <!-- ONLY agents who have a relationship with the user.
             If none, replace the rows below with a single:
             <div class="ent-offscreen-row">No relevant off-screen agents.</div> -->

        <div class="ent-offscreen-row">
          ♂️ <strong>[Name]</strong> — 📍 [Location] · [What they are doing right now.]
          <br>
          <small>🍴 [hungry/fine/full] · 😴 [exhausted/fine/rested] · 🚿 [smelly/fine/fresh] · 🚽 [fine/pressing/urgent] · 💧 [fine/thirsty/dehydrated] · 🔥 [none/simmering/high/sexual activity] · 🧠 [calm/tense/stressed] · 🎯 [Active impulse.]</small>
        </div>
      </details>

      <!-- 💕 RELATIONSHIP MATRIX -->
      <div class="ent-section">
        <div class="ent-h"><i class="fa-solid fa-heart-pulse"></i> Relationship Matrix</div>
        <div class="ent-matrix">

          <!-- One .ent-matrix-card per Name → Target pair -->
          <div class="ent-matrix-card">
            ...
            <div class="ent-matrix-row">
              <span class="ent-matrix-tag">[Emoji] [Feeling]</span>
              <span class="lbl">[Value]/1000</span>
              <span class="delta">(+/-N from [action])</span>
            </div>

            <div class="ent-matrix-sub">In The Moment</div>
            <div class="ent-matrix-row">
              <span class="ent-matrix-tag">[Emoji] [TempFeeling1]</span>
              <span class="lbl">[Value]/100</span>
              <span class="delta">(+/-N from [action])</span>
            </div>
            <div class="ent-matrix-row">
              <span class="ent-matrix-tag">[Emoji] [TempFeeling2]</span>
              <span class="lbl">[Value]/100</span>
              <span class="delta">(+/-N from [action])</span>
            </div>
            ...
            <div class="ent-matrix-row">
              <span class="lbl">[AgentName] ↔ [User]:</span> [Time since first meeting]
            </div>
      ...
      <!-- 📅 FUTURE PLANS -->
      <div class="ent-section">
        <div class="ent-h"><i class="fa-solid fa-calendar-days"></i> Future Plans</div>
        <ul class="ent-plans">
          <li>
            <i class="fa-solid fa-circle-dot"></i>
            <span class="date">[day, month]</span>
            <span>— [Concise note of upcoming agreed event.]</span>
          </li>
          <!-- More <li> as needed, chronological. If none: omit the <ul> and write
               <div class="ent-scene">No agreed plans yet.</div> instead. -->
        </ul>
      </div>
...
🩹 CONDITION: Track injuries, intoxication, illness, pain, medication, temperature discomfort. Affects vitals and behavior. If any condition exists, add an extra <span class="ent-vital">🩹 [condition]</span> at the end of that agent's vitals row.
